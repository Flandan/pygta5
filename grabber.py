...
class Grabber(object):
    def __init__(self, window=None, with_alpha=True, bbox=None):
    ...
    def grab(self, output=None):
        ...
        if self.bbox:
            ...
            x, y = 0, 0
        BitBlt(self.memoryDC, 0, 0, self.width, self.height, self.windowDC, x, y, SRCCOPY)
...
if __name__ == "__main__":
    ...
    grabber = Grabber(with_alpha=False, bbox=(0, 40, 800, 640))
    import time
    s = time.clock()
    pic = None
    for i in range(10):
